...
const MovieList = () => {
  ...
  const movies = [
    { name: "Kantara", genre: "Action", release: "2025-03-10", rating: "4.5", price: "₹250" },
    { name: "Empuraan", genre: "Thriller", release: "2025-04-01", rating: "4.7", price: "₹300" },
    { name: "Leo", genre: "Action", release: "2025-05-15", rating: "4.6", price: "₹280" },
    { name: "Jailer", genre: "Drama", release: "2025-06-20", rating: "4.3", price: "₹260" },
  ];
